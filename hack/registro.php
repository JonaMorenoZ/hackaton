      ...
      <div class="col-xs4">
        <div class="container">
          ...
          <div class="starter-template ">
            <h1 class="text-center col-xs-12">Primer paso</h1>
            <form>

          <div class="form-group row">
            <label for="inputUsuario" class="col-xs-2 form-control-label">Nombre de usuario:</label>
            <div class="col-xs-10">
              <input type="email" class="form-control" id="inputEmail3" placeholder="Usuario">
            </div>
          </div>
          <div class="form-group row">
            <label for="inputEmail3" class="col-xs-2 form-control-label">Email</label>
            <div class="col-xs-10">
              <input type="email" class="form-control" id="inputEmail3" placeholder="Email">
            </div>
          </div>
          <div class="form-group row">
            <label for="inputPassword3" class="col-xs-2 form-control-label">Contraseña</label>
            <div class="col-xs-10">
